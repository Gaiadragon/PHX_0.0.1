require ("prototypes.Agriculture.functions")
	...
	
{
	type = "tree",
	name = "rubber-seed",
	icon = "__PHX__/graphics/agriculture/rubber-tree/stage-1.png",
	order = "b-b-g",
	flags = {"placeable-neutral", "breaths-air"},
	emissions_per_tick = -0.0001,
	minable =
	...
	{
	  {
		filename = "__PHX__/graphics/agriculture/rubber-tree/stage-1.png",
		priority = "extra-high",
		width = 32,
		height = 32,
		shift = {0.0, 0.0}
  ...
  },
  {
	...
	{
	  {
		filename = "__PHX__/graphics/agriculture/rubber-tree/stage-2.png",
		priority = "extra-high",
		width = math.floor(155/4),
		height = math.floor(118/4),
		shift = {1.1/4, -1/4}
  ...
  },
  {
	...
	{
	  {
		filename = "__PHX__/graphics/agriculture/rubber-tree/stage-3.png",
		priority = "extra-high",
		width = math.floor(155*0.75),
		height = math.floor(118*0.75),
		shift = {1.1*0.75, -1*0.75}
  ...
  },
  {
	...
	{
	  {
		filename = "__PHX__/graphics/agriculture/rubber-tree/stage-4.png",
		priority = "extra-high",
		width = 155,
		height = 118,
		shift = {1.1, -1}
  ...
  
  {
	type = "tree",
	name = "sulfur-seed",
	icon = "__PHX__/graphics/agriculture/sulfur-tree/stage-1.png",
	order = "b-b-g",
	flags = {"placeable-neutral", "breaths-air"},
	emissions_per_tick = -0.0001,
	minable =
	...
	{
	  {
		filename = "__PHX__/graphics/agriculture/sulfur-tree/stage-1.png",
		priority = "extra-high",
		width = 32,
		height = 32,
		shift = {0.0, 0.0}
  ...
  },
 {
	...
	{
	  {
		filename = "__PHX__/graphics/agriculture/sulfur-tree/stage-2.png",
		priority = "extra-high",
		width = math.floor(155/4),
		height = math.floor(118/4),
		shift = {1.1/4, -1/4}
  ...
  },
  {
	...
	{
	  {
		filename = "__PHX__/graphics/agriculture/sulfur-tree/stage-3.png",
		priority = "extra-high",
		width = math.floor(155*0.75),
		height = math.floor(118*0.75),
		shift = {1.1*0.75, -1*0.75}
  ...
  },
  {
	...
	{
	  {
		filename = "__PHX__/graphics/agriculture/sulfur-tree/stage-4.png",
		priority = "extra-high",
		width = 155,
		height = 118,
		shift = {1.1, -1}
